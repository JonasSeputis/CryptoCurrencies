...
public class CryptoCurrenciesListAdapter extends RecyclerView.Adapter<CryptoCurrenciesListAdapter.CurrencyViewHolder> {
    ...
    public CryptoCurrenciesListAdapter(Context context,
    ...
    public void onBindViewHolder(@NonNull CurrencyViewHolder holder, int position) {
        holder.bind(listsObject.getCurrencies().get(position),
    ...
    public int getItemCount() {
        return listsObject.getCurrencies().size();
    }
