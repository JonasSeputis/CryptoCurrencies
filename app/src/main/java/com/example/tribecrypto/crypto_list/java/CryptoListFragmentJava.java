...
import com.example.tribecrypto.adapter.java.CryptoCurrenciesListAdapterJava;
...
import com.example.tribecrypto.utils.java.InternetConnectionJava;
...
public class CryptoListFragmentJava extends Fragment implements CryptoListViewJava, CryptoCurrenciesListAdapterJava.CurrencyViewHolder.OnItemClickJava {

    @Inject
    CryptoListPresenterJava presenter;

    private RecyclerView recyclerView;
    private Toolbar toolbar;
    private CryptoCurrenciesListAdapterJava adapter;

    @Override
    public void onAttach(@NonNull Context context) {
        DaggerCryptoListComponentJava.builder()
                .applicationComponent(ApplicationClass.Companion.getApplicationComponent(context))
                .build().inject(this);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new CryptoCurrenciesListAdapterJava(getActivity(), this);
